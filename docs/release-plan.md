...
| `release/1.20.4-neoforge` | 1.20.4 | NeoForge | 17 | Recover `1.2`, ship `1.2.1` |
| `release/1.20.1-forge` | 1.20.1 | Forge | 17 | Backport `1.2.1` |
| `release/1.19.2-forge` | 1.19.2 | Forge | 17 | Backport `1.2.1` |

## Tags

Use tags for released artifacts:

- `v1.2.1+mc1.20.4-neoforge`
- `v1.2.1+mc1.20.1-forge`
- `v1.2.1+mc1.19.2-forge`
...
3. Add `1.2.1` config to disable biome/block corruption spread.
4. Backport the finished `1.2.1` behavior to 1.20.1 Forge and 1.19.2 Forge.
