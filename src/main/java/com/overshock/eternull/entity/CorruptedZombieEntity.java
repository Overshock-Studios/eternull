...
public class CorruptedZombieEntity extends Zombie {
   public CorruptedZombieEntity(EntityType<CorruptedZombieEntity> type, Level world) {
      super(type, world);
   ...
   public SoundEvent getAmbientSound() {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.zombie.ambient"));
   }

   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound((SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.zombie.step")), 0.15F, 1.0F);
   }

   public SoundEvent getHurtSound(DamageSource ds) {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.zombie.hurt"));
   }

   public SoundEvent getDeathSound() {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.zombie.death"));
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         (EntityType)EternullModEntities.CORRUPTED_ZOMBIE.get(),
         Type.ON_GROUND,
   ...
   public static Builder createAttributes() {
      ...
      return builder.add(Attributes.SPAWN_REINFORCEMENTS_CHANCE);
   }
}
