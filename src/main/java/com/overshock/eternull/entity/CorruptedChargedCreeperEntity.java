...
public class CorruptedChargedCreeperEntity extends Creeper {
   public CorruptedChargedCreeperEntity(EntityType<CorruptedChargedCreeperEntity> type, Level world) {
      super(type, world);
