...
import com.overshock.eternull.procedures.CorruptedCreeperItIsStruckByLightningProcedure;
...
public class CorruptedCreeperEntity extends Creeper {
   public CorruptedCreeperEntity(EntityType<CorruptedCreeperEntity> type, Level world) {
      super(type, world);
   ...
   public SoundEvent getHurtSound(DamageSource ds) {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.creeper.hurt"));
   }
   ...
   public void thunderHit(ServerLevel serverWorld, LightningBolt lightningBolt) {
      ...
      CorruptedCreeperItIsStruckByLightningProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         (EntityType)EternullModEntities.CORRUPTED_CREEPER.get(),
         Type.ON_GROUND,
